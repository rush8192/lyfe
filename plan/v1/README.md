...
- The first player-loop contract is defined in [PLAYER_LOOP_AND_NARRATIVE.md](PLAYER_LOOP_AND_NARRATIVE.md). The complete generated-world opening now passes all six metabolism/allocation choices across 64 seeds with persistent micronutrient quotas. The next product risk is presentation: interaction wireframes, alert/chronicle thresholds, mutation-choice explanations, and human-playtest baselines remain open.
