...
# Core challenge and historical arc

Life in LYFE should feel hard-won. A founding species receives a plausible foothold, not a permanently safe equilibrium. In the opening game, the environment is the principal adversary: finite or intermittent resources, energy scarcity, chemical exposure, temperature and moisture variation, and the cost of merely remaining alive continually test whether a lineage fits its niche. The early game should therefore feel primarily like player versus environment—observing pressure, diagnosing its causes, and deciding whether to specialize, endure, diversify, or spread before conditions outrun the lineage.

Success creates new pressure rather than ending it. A growing population consumes its local resource flows, crowds finite opportunities, produces waste, and sends some members into less favorable surroundings. This density-dependent pressure should turn abundance into an evolutionary problem without imposing an arbitrary population cap. The autonomous Survival founder obeys the same rules and may eventually become an ecological competitor, but it is not a scripted early opponent and should not displace the environment as the opening challenge.

Direct biological antagonism is a later transition in the world's history. Founders begin without predation, and predation becomes important only after enabling traits, sufficient population density, dispersal, and contact create the opportunity for it. Its emergence should feel like a consequential ecological escalation—alongside scavenging, defense, avoidance, and prey depletion—rather than a threat that was simply switched on at setup.

Difficulty must remain causal and legible. LYFE may punish a poor fit, delayed adaptation, overshoot, or bad fortune, and extinction must remain a real outcome; it should not rely on hidden bonuses, unexplained collapse, or an unavoidable opening failure before the player can make a meaningful decision. Balance should avoid both effortless indefinite growth and constant catastrophe: the desired tension is a lineage that can prosper for a time while environmental and ecological pressures continue to create understandable reasons to evolve.
...
The core play rhythm should move from observing a change, to diagnosing its causes, to comparing evolutionary responses, to committing or deliberately waiting, and finally to observing the consequences. Players should be able to pin subjects and evolutionary goals, receive configurable alerts for meaningful or dangerous changes, and compare an ancestor with its new descendant after speciation. These are attention and interpretation tools; they do not issue commands to organisms or influence their behavior.

Evolution choices should distinguish adaptations that help immediately, physical capabilities that must be constructed after their DNA is acquired, capabilities that are complete but inactive in the current environment, and preparatory changes that only open a later path. Prerequisite-closed trait groups may be presented as milestones, but their individual costs, prerequisites, tradeoffs, and irreversible speciation transaction remain visible. The game should offer multiple strategically distinct responses rather than treating any newly affordable node as a meaningful choice.

The world should maintain a factual chronicle of observed origin, reproduction, speciation, extinction, migration, ecological, and environmental milestones. Chronicle prose may be whimsical, but it must be grounded in recorded events and authorized observations. It should help players construct species narratives without inventing causal claims or exposing hidden world state.
